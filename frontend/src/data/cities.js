// Ciudades del Perú (capitales departamentales + Callao) con sus coordenadas.
// Cajamarca va primero porque es el foco del proyecto (ciudad por defecto).
export const CITIES = [
  { name: "Cajamarca", lat: -7.1617, lon: -78.5127 },
  ...
  { name: "Ayacucho", lat: -13.1587, lon: -74.2239 },
  { name: "Huánuco", lat: -9.9306, lon: -76.2422 },
  { name: "Huaraz", lat: -9.5278, lon: -77.5278 },
  { name: "Moyobamba", lat: -6.0341, lon: -76.9711 },
  { name: "Abancay", lat: -13.6339, lon: -72.8814 },
  { name: "Huancavelica", lat: -12.7861, lon: -74.9736 },
  { name: "Cerro de Pasco", lat: -10.6828, lon: -76.2565 },
  { name: "Moquegua", lat: -17.1934, lon: -70.9355 },
  { name: "Tumbes", lat: -3.5669, lon: -80.4515 },
  { name: "Chachapoyas", lat: -6.2299, lon: -77.8688 },
